...
# Original source: https://github.com/Comfy-Org/comfy-model-tools/blob/main/quant_int8_convrot.py
# Modified 2026-09-25: print layer progress every 10 layers and at completion
# instead of every 100 layers in both quantization branches.
